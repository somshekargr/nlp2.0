...
#                         file_data = search_csv(
#                             config_file['application']['csv_file_path'], config_file['csvdata']['search_key'], FILES)[0]
#                     else:
#                         file_data = ''
#                     soup_data = BeautifulSoup(
#                         open(os.path.join(root, FILES), encoding="utf8"), 'html.parser')
#                     final_data = eval(template_function)(soup_data, str(
#                         config_file['application']['title_content']), str(config_file['application']['main_content']))
#                     if final_data:
