...
def get_list_p_table_data(soup_data, title_tag, title_tag_data, content_tag, content_tag_data):
    dict_data = []
...
#      __file__), '..', 'indianbank_data', 'indianbank_247.txt'), encoding="utf8"), 'html.parser')

# result_data = get_list_p_table_data(soup, 'innerheading', 'mainContent')
