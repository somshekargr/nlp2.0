...
def get_heading_img_list_p_data(soup_data, title_tag, title_tag_data, content_tag, content_tag_data):
    """
...
#     __file__), '..', 'indianbank_data', 'indianbank_57.txt'), encoding="utf8"), 'html.parser')
# result_data = get_heading_img_list_p_data(soup, 'innerheading', 'mainContent')
